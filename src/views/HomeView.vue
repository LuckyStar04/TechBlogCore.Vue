<template>
  <link rel="stylesheet" type="text/css" href="/src/assets/home.css"/>
  <Teleport to="body">
...
@keyframes avataranime {
  0% { transform: scale(.6) rotateY(-10deg); }
  25% { transform: scale(1.06) rotateY(45deg); }
  50% { transform: scale(1.12) rotateY(90deg) }
  100% { transform: scale(1.24) rotateY(180deg); }
}
.navigations {
  display: flex;
  width: 100%;
